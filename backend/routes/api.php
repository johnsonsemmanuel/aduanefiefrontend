...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'rest'], function () {
        ...
        /* Parcel Options */
        Route::apiResource('parcel-options',        Rest\ParcelOptionController::class)->only(['index', 'show']);
        ...
        /* Units */
        Route::get('units/paginate',                          [Rest\UnitController::class, 'paginate']);
        Route::get('units/{id}',                              [Rest\UnitController::class, 'show']);
        ...
        /* rest payments */
        Route::any('order-stripe-process', 		 [Payment\StripeController::class, 		'orderProcessTransaction']);
        Route::any('order-my-fatoorah-process',  [Payment\MyFatoorahController::class, 	'orderProcessTransaction']);
        Route::any('order-iyzico-process', 		 [Payment\IyzicoController::class, 		'orderProcessTransaction']);
        Route::any('order-razorpay-process', 	 [Payment\RazorPayController::class, 	'orderProcessTransaction']);
        Route::any('order-mercado-pago-process', [Payment\MercadoPagoController::class, 'orderProcessTransaction']);
        Route::any('order-paystack-process', 	 [Payment\PayStackController::class, 	'orderProcessTransaction']);
        Route::any('order-paypal-process', 		 [Payment\PayPalController::class, 		'orderProcessTransaction']);
        Route::any('order-flutter-wave-process', [Payment\FlutterWaveController::class, 'orderProcessTransaction']);
        Route::any('order-paytabs-process', 	 [Payment\PayTabsController::class, 	'orderProcessTransaction']);
        Route::any('order-moya-sar-process', 	 [Payment\MoyasarController::class, 	'orderProcessTransaction']);
        Route::any('order-zain-cash-process', 	 [Payment\ZainCashController::class, 	'orderProcessTransaction']);
        Route::any('order-mollie-process', 	 	 [Payment\MollieController::class, 		'orderProcessTransaction']);
        Route::any('order-maksekeskus-process',  [Payment\MaksekeskusController::class, 'orderProcessTransaction']);
        Route::any('order-pay-fast-process', 	 [Payment\PayFastController::class, 	'orderProcessTransaction']);
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            Route::get('order-details/{id}/custom',			    [User\OrderController::class, 'customOrderDetailsByShop']);
        ...
        Route::group(['prefix' => 'seller', 'middleware' => ['sanctum.check', 'role:seller|moderator'], 'as' => 'seller.'], function () {
            ...
            Route::get('waiter/orders/report',          [Seller\OrderReportController::class, 'waiterReport']);
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:admin|manager'], 'as' => 'admin.'], function () {
            ...
            Route::get('term/{type}',               [Admin\TermsController::class, 'show']);
            ...
            Route::get('policy/{type}',             [Admin\PrivacyPolicyController::class, 'show']);
...
//            Route::get('extras/report/paginate',    [Admin\ProductController::class,   'extrasReportPaginate']);
            ...
            Route::get('waiter/orders/report',       [Admin\OrderController::class, 'waiterReport']);
            ...
            Route::get('coupons/drop/all',  [Admin\CouponController::class, 'dropAll']);
