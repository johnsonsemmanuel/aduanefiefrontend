...
class FarmPaginateConversation extends Conversation
{
        ...
        if ($shops->hasMorePages() && $shops->currentPage() > 1) {
            $buttons[] = [
                [
                    ...
                    'callback_data'   => '/farm_offset_' . ($shops->currentPage() > 1 ? $shops->currentPage() - 1 : 1),
                ],
                [
                    'text'            => __('telegram.' . TelegramError::NEXT, locale: $locale),
                    'callback_data'   => '/farm_offset_' . ($shops->currentPage() + 1),
                ]
            ];
