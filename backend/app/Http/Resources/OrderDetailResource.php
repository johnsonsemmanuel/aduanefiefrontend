...
class OrderDetailResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'custom_status_note' => $this->when($this->custom_status_note, $this->custom_status_note),
            'custom_unit_id'     => $this->when($this->custom_unit_id, $this->custom_unit_id),
            'custom_photo'       => $this->when($this->custom_photo, $this->custom_photo),
            'custom_name'        => $this->when($this->custom_name, $this->custom_name),
