...
class OrderReportRepository extends CoreRepository
{
    ...
    public function report(array $filter = []): array
    {
        ...
        return [
            'last_order_total_price'    => round(data_get($lastOrder, 'total_price', 0), 2),
            'last_order_income'         => round(data_get($lastOrder, 'delivery_fee', 0), 2),
            'total_price'               => data_get($orders, 'delivery_fee', 0),
