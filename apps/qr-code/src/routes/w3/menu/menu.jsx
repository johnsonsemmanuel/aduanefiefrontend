...
import { TableName } from "../../../components/table-name/index.js";
...
const W2Menu = () => {
  ...
  const isLoading = isRecommendedLoading || productsLoading;
  ...
  return (
    <Container className="w2-container" maxWidth="sm">
      <W2FoodDetail
        ...
        id={selectedFood}
      />
      <W2Header onSearchChange={handleSearch} type="w3" />
      ...
      {/*    columnGap={2}*/}
      {/*  >*/}
      {/*    <Chip icon={<WifiIcon />} label={settings?.wifi_data?.wifi_name} />*/}
      {/*    <Chip*/}
