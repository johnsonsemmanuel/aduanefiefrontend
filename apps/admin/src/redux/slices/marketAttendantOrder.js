...
export const handleSearch = createAsyncThunk(
  'order/market.attendant/handleSearch',
  (params = {}) => {
    return orderService
...
export const fetchOrders = createAsyncThunk(
  'order/market.attendant/fetchOrders',
  (params = {}) => {
    return orderService
      .getAll({ ...initialState.params, ...params })
      .then((res) => res);
...
export const fetchNewOrders = createAsyncThunk(
  'order/market.attendant/fetchNewOrders',
  (params = {}) => {
    return orderService
...
export const fetchAcceptedOrders = createAsyncThunk(
  'order/market.attendant/fetchAcceptedOrders',
  (params = {}) => {
    return orderService
...
export const fetchReadyOrders = createAsyncThunk(
  'order/market.attendant/fetchReadyOrders',
  (params = {}) => {
    return orderService
...
export const fetchOnAWayOrders = createAsyncThunk(
  'order/market.attendant/fetchOnAWayOrders',
  (params = {}) => {
    return orderService
...
export const fetchDeliveredOrders = createAsyncThunk(
  'order/market.attendant/fetchDeliveredOrders',
  (params = {}) => {
    return orderService
...
export const fetchCanceledOrders = createAsyncThunk(
  'order/market.attendant/fetchCanceledOrders',
  (params = {}) => {
    return orderService
