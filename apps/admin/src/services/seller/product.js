...
const productService = {
  ...
  create: (body) => request.post(`dashboard/seller/products`, body),
  export: (params) =>
  ...
  update: (uuid, body) =>
    request.put(`dashboard/seller/products/${uuid}`, body),
  delete: (params) =>
  ...
  updatePackhouses: (data) =>
    request.post('dashboard/seller/products/multi/packhouse/update', data),
};
