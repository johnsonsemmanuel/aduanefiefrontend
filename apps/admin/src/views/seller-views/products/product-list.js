...
import UpdatePackhouses from './update-packhouses';
...
const ProductList = () => {
  ...
  const [isOpenUpdatePackhouses, setOpenUpdatePackhouses] = useState(false);
  ...
  const [columns, setColumns] = useState([
    ...
    },
    {
      ...
      is_show: true,
      render: (packhouse) =>
        packhouse?.translation?.title || packhouse?.id || t('N/A'),
    },
    {
      title: t('type'),
      dataIndex: 'type',
    ...
    <>
      <Card>
        ...
        <Space wrap>
          ...
          <Button onClick={() => setOpenUpdatePackhouses(true)}>
            {t('update.packhouses')}
          </Button>
      ...
      {isOpenUpdatePackhouses && (
        <Modal
          visible={isOpenUpdatePackhouses}
          onCancel={() => setOpenUpdatePackhouses(false)}
          footer={false}
          title={t('update.packhouses')}
        >
          <UpdatePackhouses
            handleClose={() => {
              setOpenUpdatePackhouses(false);
            }}
            refetchProductList={() => {
              dispatch(setRefetch(activeMenu));
            }}
