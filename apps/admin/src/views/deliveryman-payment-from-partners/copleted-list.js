...
import { fetchCourierPaymentFromPartners } from 'redux/slices/paymentToPartners';
const { RangePicker } = DatePicker;

export default function CourierPaymentFromPartners() {
  ...
  useDidUpdate(() => {
    dispatch(fetchCourierPaymentFromPartners(paramsData));
  }, [data, dateRange, type]);
