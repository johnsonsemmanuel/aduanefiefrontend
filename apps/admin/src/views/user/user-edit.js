...
import DeliverySettingCreate from './add-courier-settings';
import UserEditForm from './userEditForm';
import UserOrders from './userOrders';
import WalletHistory from './walletHistory';
import UserPassword from './userPassword';
import CourierZone from './courier-zone';
    ...
    <Card title={t('user.settings')}>
      {!loading ? (
        ...
        >
          ...
          {role === 'courier' && (
            <>
              <TabPane key='delivery' tab={t('courier')}>
                <DeliverySettingCreate id={id} data={activeMenu.data} />
              </TabPane>
              <TabPane key='courierzone' tab={t('courier.zone')}>
                <CourierZone user_id={activeMenu.data?.id} />
              </TabPane>
            </>
          )}
