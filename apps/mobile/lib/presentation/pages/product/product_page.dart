...
import 'package:aduanefie/infrastructure/models/data/review_data.dart';
import 'package:aduanefie/infrastructure/services/services.dart';
import 'package:aduanefie/presentation/app_assets.dart';
import 'package:aduanefie/presentation/pages/product/widgets/w_ingredient.dart';
                        ...
                        Stack(
                          children: [
                            SizedBox(
                              height: 200.r,
                              child:
                                  (state.productData?.galleries?.isNotEmpty ??
                                      false)
                                  ? PageView.builder(
                                      itemCount:
                                          state
