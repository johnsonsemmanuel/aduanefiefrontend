...
import 'package:aduanefie/presentation/pages/shop/group_order/widgets/check_status_dialog.dart';
        ...
        child: BackdropFilter(
          ...
          child: Container(
            decoration: BoxDecoration(
              boxShadow: [
                BoxShadow(
                  color: AppStyle.white.withValues(alpha: 0.25),
                  spreadRadius: 0,
                  blurRadius: 40,
                  offset: const Offset(0, -2), // changes position of shadow
                ),
              ],
              color: widget.colors.backgroundColor.withValues(alpha: 0.9),
              borderRadius: BorderRadius.only(
                topLeft: Radius.circular(12.r),
                topRight: Radius.circular(12.r),
              ),
              ...
              child: ExpansionTile(
                ...
                children: [
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount:
                        state.cart?.userCarts?[index].cartDetails?.length ?? 0,
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                16.verticalSpace,
                Divider(color: AppStyle.textGrey.withValues(alpha: 0.1)),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppHelpers.numberFormat(state.cart?.totalPrice),
                  style: AppStyle.interSemi(size: 20, color: colors.textBlack),
                ),
              ],
            ),
          ),
