...
import 'package:aduanefie/application/search/search_state.dart';
import 'package:aduanefie/infrastructure/services/services.dart';
import 'package:aduanefie/presentation/theme/theme.dart';
import 'package:aduanefie/application/search/search_notifier.dart';
import 'package:aduanefie/application/search/search_provider.dart';
...
class _SearchPageState extends ConsumerState<SearchPage> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: state.search.isEmpty
                  ? _categoryAndSearchHistory(state, context, colors)
                  : _searchResultBody(context, state, colors),
            ),
          ],
        ),
  ...
  Widget _categoryAndSearchHistory(
    SearchState state,
    BuildContext context,
    CustomColorSet colors,
  ) {
