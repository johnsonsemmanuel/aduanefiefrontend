...
class FilterNotifier extends Notifier<FilterState> {
  ...
  Future<void> init(BuildContext context, int categoryId) async {
    ...
    final connected = await AppConnectivity.connectivity();
    if (connected) {
      final response = await shopsRepository.getTags(categoryId);
      final res = await shopsRepository.getSuggestPrice();
      response.when(
        success: (data) async {
  ...
  Future<void> fetchFarm(BuildContext context, int categoryId) async {
    final connected = await AppConnectivity.connectivity();
    if (connected) {
