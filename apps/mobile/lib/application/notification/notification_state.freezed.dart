...
mixin _$NotificationState {
 ...
 List<NotificationModel> get notifications; CountNotificationModel? get countOfNotifications; bool get isReadAllLoading; bool get isAllNotificationsLoading;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(notifications),countOfNotifications,isReadAllLoading,isAllNotificationsLoading);
...
@useResult
$Res call({
 List<NotificationModel> notifications, CountNotificationModel? countOfNotifications, bool isReadAllLoading, bool isAllNotificationsLoading
});
...
/// Create a copy of NotificationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? notifications = null,Object? countOfNotifications = freezed,Object? isReadAllLoading = null,Object? isAllNotificationsLoading = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<NotificationModel> notifications,  CountNotificationModel? countOfNotifications,  bool isReadAllLoading,  bool isAllNotificationsLoading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationState() when $default != null:
return $default(_that.notifications,_that.countOfNotifications,_that.isReadAllLoading,_that.isAllNotificationsLoading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<NotificationModel> notifications,  CountNotificationModel? countOfNotifications,  bool isReadAllLoading,  bool isAllNotificationsLoading)  $default,) {final _that = this;
switch (_that) {
case _NotificationState():
return $default(_that.notifications,_that.countOfNotifications,_that.isReadAllLoading,_that.isAllNotificationsLoading);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<NotificationModel> notifications,  CountNotificationModel? countOfNotifications,  bool isReadAllLoading,  bool isAllNotificationsLoading)?  $default,) {final _that = this;
switch (_that) {
case _NotificationState() when $default != null:
return $default(_that.notifications,_that.countOfNotifications,_that.isReadAllLoading,_that.isAllNotificationsLoading);case _:
  return null;
...
class _NotificationState extends NotificationState {
  const _NotificationState({final  List<NotificationModel> notifications = const [], this.countOfNotifications = null, this.isReadAllLoading = false, this.isAllNotificationsLoading = false}): _notifications = notifications,super._();
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_notifications),countOfNotifications,isReadAllLoading,isAllNotificationsLoading);
...
/// Create a copy of NotificationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? notifications = null,Object? countOfNotifications = freezed,Object? isReadAllLoading = null,Object? isAllNotificationsLoading = null,}) {
